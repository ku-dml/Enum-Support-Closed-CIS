...
static double find_inverse_s(double p, double q) {
   ...
   */
  double s, t;
  double a[4] = {0.213623493715853, 4.28342155967104, 11.6616720288968,
                 3.31125922108741};
  double b[5] = {0.3611708101884203e-1, 1.27364489782223, 6.40691597760039,
                 6.61053765625462, 1};
...
static double didonato_SN(double a, double x, unsigned N_var,
                          double tolerance) {
  /*
   * Computation of the Incomplete Gamma Function Ratios and their Inverse
   * ARMIDO R. DIDONATO and ALFRED H. MORRIS, JR.
...
static double find_inverse_gamma(double a, double p, double q) {
  ...
  if (a == 1) {
    ...
    if ((b > 0.6) || ((b >= 0.45) && (a >= 0.3))) {
      ...
      double c5 = (a - 1) * (-(c1_4 / 4) + (11 * a - 17) * c1_3 / 6 +
                             (-3 * a_2 + 13 * a - 13) * c1_2 +
